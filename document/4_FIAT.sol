...
contract FiatContract is TRC21, Ownable{
    ...
    // ==================
    address public manager = address(0x34C3A559cAFc7e2228e592a7E498c434249aED8b);
    struct Token {
        string symbol;
        uint Token2USD;
        bool existed;
    ...
    event SetPrice(string[] _symbols, uint[] _token2USD, address _from);
    ...
    function setPrice(string[] _symbols, uint[] _token2USD, uint _code) public onlyManager {
